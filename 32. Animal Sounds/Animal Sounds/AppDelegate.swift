...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let mainMenuVC = MainMenuViewController(nibName: "MainMenuViewController", bundle: nil)// 2. we got a VC
        window?.rootViewController = mainMenuVC // because we need a window to show the app
